...
public class MyMessagingService extends Service {
    public static final String READ_ACTION = "com.wisethan.myautomessagetest.ACTION_MESSAGE_READ";
    public static final String REPLY_ACTION = "com.wisethan.myautomessagetest.ACTION_MESSAGE_REPLY";
    ...
    private Intent createIntent(int conversationId, String action) {
        return new Intent().addFlags(Intent.FLAG_INCLUDE_STOPPED_PACKAGES).setAction(action).putExtra(CONVERSATION_ID, conversationId);
    }
